...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if ($error_jenis_pendaftaran =="" && $error_tanggal_masuk_sekolah=="" && $error_nis =="" && $error_nomer_peserta_ujian=="" && $error_pernah_paud==""
    && $error_pernah_tk=="" && $error_skhun=="" && $error_ijazah=="" && $error_hobi=="" && $error_citacita=="" && $error_nama=="" && 
    $error_jenis_kelamin=="" && $error_nisn=="" && $error_nik=="" && $error_tempat_lahir=="" && $error_tanggal_lahir=="" && $error_agama=="" 
    && $error_berkebutuhan_khusus=="" && $error_alamat=="" && $error_rt=="" && $error_rw=="" && $error_dusun=="" && $error_desa=="" && 
    $error_kecamatan=="" && $error_kode_pos=="" && $error_tempat_tinggal=="" && $error_transportasi=="" && $error_hp=="" && $error_email=="" 
    && $error_telp=="" && $error_penerima_kps=="" && $error_no_kps=="" && $error_kewarganegaraan=="" && $error_nama_negara=="") {
	
	include 'koneksi.php';

	//Memasukkan data ke tabel data_diri
	$query="INSERT INTO data_diri VALUES ('', '$jenis_pendaftaran', '$tanggal_masuk_sekolah', '$nis', '$nomer_peserta_ujian', '$pernah_paud', 
    '$pernah_tk', '$skhun', '$ijazah', '$hobi', '$citacita', '$nama', '$jenis_kelamin', '$nisn', '$nik', '$tempat_lahir', '$tanggal_lahir', 
    '$agama', '$berkebutuhan_khusus', '$alamat', '$rt', '$rw', '$dusun', '$desa', '$kecamatan', '$kode_pos', '$tempat_tinggal', '$transportasi', 
    '$hp', '$telp', '$email', '$penerima_kps', '$no_kps', '$kewarganegaraan', '$nama_negara')";
			...
			<div class="card-body">
				...
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" name="tanggal_masuk_sekolah" class="form-control <?php echo ($error_tanggal_masuk_sekolah !="" ? 
                            "is_invalid" : ""); ?>" id="tanggal_masuk_sekolah" placeholder="Tanggal Masuk Sekolah" value="<?php echo 
                            $tanggal_masuk_sekolah; ?>"><label>Contoh: 24-12-2020</label><span class="warning"><?php echo 
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" name="nomer_peserta_ujian" class="form-control <?php echo ($error_nomer_peserta_ujian !="" ? 
                            "is_invalid" : ""); ?>" id="nomer_peserta_ujian" placeholder="Nomer Peserta Ujian" value="<?php echo 
                            $nomer_peserta_ujian; ?>"><span class="warning"><?php echo $error_nomer_peserta_ujian; ?></span>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" name="tanggal_lahir" class="form-control <?php echo ($error_tanggal_lahir !="" ? 
                            "is_invalid" : ""); ?>" id="tanggal_lahir" placeholder="Tanggal Lahir" value="<?php echo $tanggal_lahir; ?>">
                            <label>Contoh: 23-09-2000</label><span class="warning"><?php echo $error_tanggal_lahir; ?></span>
						</div>
					</div>
